...
# Make preparing FMO and Isotype controls a separate function; each necessary table passed as a list?
# helper to evaluate one channel at a time?
de_results <- doDEAnalysisNew(fsom_dt, 
                              sample_df = sample_info, 
                              design = design, 
                              contrasts = contrasts, 
...
```{r de-analysis-tables, echo=FALSE, eval=FALSE}
de_results[[1]] %>%
# de_results$tests[[1]] %>%
  knitr::kable(
    format = "html",
