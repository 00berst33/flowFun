...
#'
#' @return A heatmap of MFIs made with [ComplexHeatmap::Heatmap()], 
...
#' @param ... Additional parameters to pass to \code{ComplexHeatmap::Heatmap()}.
#'
#' @return A heatmap of MFIs made with [ComplexHeatmap::Heatmap()], where each 
...
#' and named via \code{\link[FlowSOM]{UpdateMetaclusters}}.
